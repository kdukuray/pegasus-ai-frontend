...
export default function ChatTextInput({setTextAreaValue, handleChatSubmit}: 
    {setTextAreaValue: any, handleChatSubmit: any}){
    ...
    return (
        <div className="bg-white left-64 right-0 min-h-24 bottom-0 pb-10 fixed">
            ...
            <Textarea  onChange={(e)=>setTextAreaValue(e.target.value)} contentEditable="true" 
